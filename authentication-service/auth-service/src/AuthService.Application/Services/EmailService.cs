...
public class EmailService : IEmailService
{
    ...
    public async Task SendVerificationEmail(string toEmail, string token)
    {
        ...
        if (!hasLogo)
            _logger.LogWarning("El archivo de logo no se encontró en: {Path}", logoPath);
...
<table width='100%' cellpadding='0' cellspacing='0' style='background-color:#f4f6f9;padding:40px 0;'>
    ...
    public async Task SendVerificationEmailWithStudentData(string toEmail, string token, string studentName, string studentCarnet, string studentSection)
    {
        var senderEmail = _config["EmailSettings:Email"] ?? throw new InvalidOperationException("Email not configured");
        var password = _config["EmailSettings:Password"] ?? throw new InvalidOperationException("Email password not configured");
        var host = _config["EmailSettings:Host"] ?? "smtp.gmail.com";
...
<table width='100%' cellpadding='0' cellspacing='0' style='background-color:#f4f6f9;padding:40px 0;'>
    ...
    <td align='center'>
        ...
        <tr>
            ...
            <h2 style='margin:0 0 12px;color:#1a1a2e;font-size:20px;'>¡Bienvenido a K-DontForget!</h2>
            <p style='margin:0 0 20px;color:#555;font-size:15px;line-height:1.6;'>
                Gracias por registrarte en el sistema de citas de la Fundación Kinal.
            </p>

            <!-- Información del estudiante -->
            <table width='100%' cellpadding='0' cellspacing='0' style='background:#f8f9fa;border-radius:8px;padding:20px;margin:20px 0;'>
                <tr>
                    <td style='padding:0;'>
                        <h3 style='margin:0 0 15px;color:#1a1a2e;font-size:16px;border-bottom:2px solid #C9A84C;padding-bottom:8px;'>Datos del Estudiante</h3>
                        <p style='margin:0 0 8px;color:#555;font-size:14px;'>
                            <strong>Nombre:</strong> {studentName}
                        </p>
                        <p style='margin:0 0 8px;color:#555;font-size:14px;'>
                            <strong>Carnet:</strong> {studentCarnet}
                        </p>
                        <p style='margin:0;color:#555;font-size:14px;'>
                            <strong>Sección Técnica:</strong> {studentSection}
                        </p>
                    </td>
                </tr>
            </table>
            ...
            <p style='margin:0 0 20px;color:#555;font-size:15px;line-height:1.6;'>
                Para activar tu cuenta y comenzar a gestionar las citas de tu estudiante,
                haz clic en el botón de abajo.
            </p>
